...
def upload_file(connection, container_path, files_directory):
    ...
    files = [f for f in listdir(files_directory) if isfile(join(files_directory, f))]
...
def parser():
    ...
    **Write a file to a container on the objectstore.**
    ...
    parser.add_argument('directory',
                        type=str,
                        help='Specify the directory of the files')
...
def main():
    ...
    upload_file(connection, args.container_path, args.directory)
